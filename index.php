...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Omnifood is a premium food delivery service with the mission to bring affordable healthy meals to as many people as possible.">
      ...
      <div class="row">
        ...
        <div class="col span-1-of-2 steps-box js--wp-5">
          <div class="works-step">
            <div>1</div>
            <p>Choose the subscription plan that fits your needs and sign up today.</p>
          </div>
          <div class="works-step">
            <div>2</div>
            <p>Order a delicious meal using our mobile app, website, or call us!</p>
          </div>
          <div class="works-step">
            <div>3</div>
            <p>Enjoy meals after less than 20 minutes. See you the next time!</p>
          </div>
          ...
          <div class="plan-box">
            ...
            <div>
              <ul>
                ...
                <li><ion-icon name="checkmark"></ion-icon>Order 8am to 12pm</li>
                <li><ion-icon name="close"></ion-icon>Access to newest creations</li>
                <li><ion-icon name="checkmark"></ion-icon>Free delivery</li>
              </ul>
            </div>
            <div>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-140596349-1"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-140596349-1');
  </script>
